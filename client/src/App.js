...
class App extends Component {
  state = { loaded: false, kycAddress: "0x123", tokenSaleAddress: "", userTokens: 0, totalTokens: 0 };
  ...
  updateUserTokens = async () => {
    let totalTokens = await this.myToken.methods.totalSupply().call();
    let userTokens = await this.myToken.methods.balanceOf(this.accounts[0]).call();
    this.setState({ userTokens: userTokens, totalTokens: totalTokens });
  }
